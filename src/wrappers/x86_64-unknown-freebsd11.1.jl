# Autogenerated wrapper script for Geant4Builder_jll for x86_64-unknown-freebsd11.1
export libG4Global, libG4ParModels, libG4Material, libG4Readout, libG4Particles, libG4Digits, libG4Event, libG4Mocren, libG4Tree, libG4visManagement, libG4Tracking, libG4VisHepRep, libG4Intercoms, libG4VisXXX, libG4FR, libG4Graphics, libG4Run, libG4Zlib, libG4Geometry, libG4Persistency, libG4Track, libG4PhysicsLists, libG4Processes, libG4Analysis, libG4Modeling, libG4VRML, libG4Interfaces, libG4ErrorPropagation, libG4CLHEP, libG4RayTracer
...
function __init__()
    ...
    global libG4Global_path = abspath(joinpath(artifact"Geant4Builder", libG4Global_splitpath...))
    ...
    global libG4ParModels_path = abspath(joinpath(artifact"Geant4Builder", libG4ParModels_splitpath...))
    ...
    global libG4Material_path = abspath(joinpath(artifact"Geant4Builder", libG4Material_splitpath...))
    ...
    global libG4Readout_path = abspath(joinpath(artifact"Geant4Builder", libG4Readout_splitpath...))
    ...
    global libG4Particles_path = abspath(joinpath(artifact"Geant4Builder", libG4Particles_splitpath...))
    ...
    global libG4Digits_path = abspath(joinpath(artifact"Geant4Builder", libG4Digits_splitpath...))
    ...
    global libG4Event_path = abspath(joinpath(artifact"Geant4Builder", libG4Event_splitpath...))
    ...
    global libG4Mocren_path = abspath(joinpath(artifact"Geant4Builder", libG4Mocren_splitpath...))
    ...
    global libG4Tree_path = abspath(joinpath(artifact"Geant4Builder", libG4Tree_splitpath...))
    ...
    global libG4visManagement_path = abspath(joinpath(artifact"Geant4Builder", libG4visManagement_splitpath...))
    ...
    global libG4Tracking_path = abspath(joinpath(artifact"Geant4Builder", libG4Tracking_splitpath...))
    ...
    global libG4VisHepRep_path = abspath(joinpath(artifact"Geant4Builder", libG4VisHepRep_splitpath...))
    ...
    global libG4Intercoms_path = abspath(joinpath(artifact"Geant4Builder", libG4Intercoms_splitpath...))
    ...
    global libG4VisXXX_path = abspath(joinpath(artifact"Geant4Builder", libG4VisXXX_splitpath...))
    ...
    global libG4FR_path = abspath(joinpath(artifact"Geant4Builder", libG4FR_splitpath...))
    ...
    global libG4Graphics_path = abspath(joinpath(artifact"Geant4Builder", libG4Graphics_splitpath...))
    ...
    global libG4Run_path = abspath(joinpath(artifact"Geant4Builder", libG4Run_splitpath...))
    ...
    global libG4Zlib_path = abspath(joinpath(artifact"Geant4Builder", libG4Zlib_splitpath...))
    ...
    global libG4Geometry_path = abspath(joinpath(artifact"Geant4Builder", libG4Geometry_splitpath...))
    ...
    global libG4Persistency_path = abspath(joinpath(artifact"Geant4Builder", libG4Persistency_splitpath...))
    ...
    global libG4Track_path = abspath(joinpath(artifact"Geant4Builder", libG4Track_splitpath...))
    ...
    global libG4PhysicsLists_path = abspath(joinpath(artifact"Geant4Builder", libG4PhysicsLists_splitpath...))
    ...
    global libG4Processes_path = abspath(joinpath(artifact"Geant4Builder", libG4Processes_splitpath...))
    ...
    global libG4Analysis_path = abspath(joinpath(artifact"Geant4Builder", libG4Analysis_splitpath...))
    ...
    global libG4Modeling_path = abspath(joinpath(artifact"Geant4Builder", libG4Modeling_splitpath...))
    ...
    global libG4VRML_path = abspath(joinpath(artifact"Geant4Builder", libG4VRML_splitpath...))
    ...
    global libG4Interfaces_path = abspath(joinpath(artifact"Geant4Builder", libG4Interfaces_splitpath...))
    ...
    global libG4ErrorPropagation_path = abspath(joinpath(artifact"Geant4Builder", libG4ErrorPropagation_splitpath...))
    ...
    global libG4CLHEP_path = abspath(joinpath(artifact"Geant4Builder", libG4CLHEP_splitpath...))
    ...
    global libG4RayTracer_path = abspath(joinpath(artifact"Geant4Builder", libG4RayTracer_splitpath...))
